[![Publish Docker Dev image](https://github.com/Domochip/gardena2mqtt/actions/workflows/docker-publish-release.yml/badge.svg)](actions/workflows/docker-publish-release.yml)
# Prerequisites

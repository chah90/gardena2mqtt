[![Publish Docker image](https://github.com/Domochip/gardena2mqtt/actions/workflows/docker-publish-release.yml/badge.svg)]([actions/workflows/docker-publish-release.yml](https://github.com/Domochip/gardena2mqtt/actions/workflows/docker-publish-release.yml))
[![Publish Docker Dev image](https://github.com/Domochip/gardena2mqtt/blob/master/.github/workflows/docker-publish-dev.yml/badge.svg)]([actions/workflows/docker-publish-release.yml](https://github.com/Domochip/gardena2mqtt/blob/master/.github/workflows/docker-publish-dev.yml))
# Prerequisites
